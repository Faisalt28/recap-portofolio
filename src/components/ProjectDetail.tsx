    ...
    <div className="min-h-screen" style={{ background: 'var(--bg)' }}>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        ...
        >
          ...
          {/* 1. HEADER PROYEK */}
          {/* ========================================================================= */}
          <section className="pb-6 sm:pb-8 border-b" style={{ borderColor: 'var(--border)' }}>
            {/* Title */}
            <h1
              className="text-2xl sm:text-4xl md:text-5xl font-extrabold tracking-tight mb-3 sm:mb-4 break-words"
            ...
            <p
              className="text-sm sm:text-base md:text-lg leading-relaxed max-w-3xl mb-6 sm:mb-8"
              style={{ color: 'var(--text-secondary)' }}
            >
              {project.description}
            </p>
              ...
              {isWeb ? (
                <>
                  ...
                  <a
                    ...
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl font-bold text-xs sm:text-sm text-white transition-all hover:scale-105 cursor-pointer shadow-md"
                    style={{
                  ...
                  {project.githubLink && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 sm:py-3 rounded-xl font-medium text-xs sm:text-sm transition-all hover:scale-105 cursor-pointer"
                      style={{
          ...
          <section>
            ...
            <div
              className="p-4 sm:p-7 rounded-2xl leading-relaxed text-xs sm:text-base"
              style={{
                background: 'var(--bg-card)',
                border: '1px solid var(--border)',
          ...
          <section>
            ...
            <div className="p-4 sm:p-5 rounded-2xl mb-4 sm:mb-6" style={{ background: 'var(--bg-subtle)', border: '1px solid var(--border)' }}>
              <h4 className="text-xs font-mono uppercase tracking-wider mb-2.5 sm:mb-3" style={{ color: 'var(--text-muted)' }}>
              ...
              <div className="flex flex-wrap gap-1.5 sm:gap-2">
                {project.techStack.map(tech => (
                  <span
                    key={tech}
                    className="px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-lg text-[11px] sm:text-xs font-mono font-medium transition-transform hover:scale-105"
            ...
            {project.architecture && project.architecture.length > 0 && (
              <div className="rounded-2xl overflow-hidden" style={{ border: '1px solid var(--border)' }}>
                {project.architecture.map((item, idx) => (
                  <div
                    key={idx}
                    className="px-4 sm:px-5 py-2.5 sm:py-3.5 flex flex-col sm:flex-row sm:items-center justify-between gap-1 sm:gap-1.5 text-xs sm:text-sm"
                    style={{
                  ...
                  >
                    ...
                    <span className="font-mono font-semibold sm:text-right break-words" style={{ color: 'var(--text-primary)' }}>
                      {item.value}
                    </span>
                  </div>
                ))}
          ...
          <section id="demo-showcase-section">
            ...
            {isWeb ? (
              ...
              >
                {/* Browser bar */}
                <div
                  className="px-3 sm:px-4 py-2 sm:py-2.5 flex items-center justify-between gap-2 sm:gap-3"
                ...
                >
                  ...
                  <div
                    className="flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[11px] sm:text-xs font-mono min-w-0 max-w-xs sm:max-w-sm flex-1 truncate"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[11px] sm:text-xs flex items-center gap-1 hover:text-emerald-500 transition-colors shrink-0"
                ...
                {project.videoSrc ? (
                  <video
                    ...
                    className="w-full max-h-[420px] sm:max-h-[540px] md:max-h-[640px] object-contain bg-black"
                  />
                ) : (
                  <img
                    src={project.imgSrc}
                    alt={project.title}
                    className="w-full object-cover object-top max-h-[360px] sm:max-h-[540px]"
                  />
                )}
              </div>
            ) : (
              ...
              <div
                className="mb-8 flex flex-col items-center justify-center p-4 sm:p-8 rounded-2xl"
                style={{ background: 'var(--bg-card)', border: '1px solid var(--border)' }}
              >
                <div className="text-center mb-5 sm:mb-6">
                  <span
                    className="inline-flex items-center gap-1.5 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full text-[11px] sm:text-xs font-mono font-medium mb-2"
                ...
                <div className="relative w-full max-w-[270px] sm:max-w-[310px] rounded-[32px] sm:rounded-[36px] p-1.5 sm:p-2 shadow-2xl bg-neutral-950 border-2 border-neutral-700/70 ring-1 ring-white/10">
                  {/* Phone Screen: 9:20 aspect ratio matching 576x1280 */}
                  <div className="relative rounded-[26px] sm:rounded-[28px] overflow-hidden bg-black aspect-[9/20] flex items-center justify-center shadow-inner">
                    {project.videoSrc ? (
                      <video
                        src={project.videoSrc}
                        controls
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                  {project.screenshots.map((item, idx) => (
                    <div
                      key={idx}
                      className="flex flex-col items-center p-3.5 sm:p-4 rounded-2xl"
                      style={{
                        background: 'var(--bg-card)',
                        border: '1px solid var(--border)',
                        boxShadow: 'var(--shadow)',
                    ...
                    >
                      ...
                      <div className="relative w-full max-w-[250px] sm:max-w-[270px] rounded-[28px] sm:rounded-[30px] p-1.5 sm:p-2 bg-neutral-950 border border-neutral-700/70 shadow-2xl ring-1 ring-white/10 mb-4 transition-transform duration-300 hover:scale-[1.02]">
                      ...
                      <div className="text-center w-full px-1">
                        <h4 className="text-xs font-bold mb-1 break-words" style={{ color: 'var(--text-primary)' }}>
                          {item.title}
                        </h4>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                  {project.features.map((feat, idx) => (
                    <div
                      ...
                      style={{ background: 'var(--bg-card)', border: '1px solid var(--border)' }}
                    >
                      <h4 className="text-xs sm:text-sm font-bold mb-1.5 flex items-center gap-2 break-words" style={{ color: 'var(--text-primary)' }}>
